...
class AuthSession(Base):
    """One browser sign-in. The raw refresh token lives only client-side;
    this row holds its hash, rotates on every refresh, and carries the
    remember/inactivity semantics."""
